...
class Polygon
{
     ...
     * Constructor.
     *
     * @param array<Point> $points Array of points that make up the polygon
     *
     * @throws FirstAndLastPointNotEqualException
    ...
    {
        if (0 == $idx || $idx == count($this->getPoints())) {
    ...
    public function getCentroid(): Point
    {
        ...
        for (; $pointsCount < $elemCount - 1; ++$pointsCount) {
    ...
    public function containsPoint(Point $point): bool
    {
        ...
        do {
            ...
            if ($linePointToExtreme->intersectsLine($lineIToNext)) {
                ...
                // otherwise false
                if (0 == $this->orientation($polygonPoints[$i], $point, $polygonPoints[$next])) {
